            ...
            <div className="row">
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-12">
                            <h6 className="font-weight-bold">Price per day : <span className="badge badge-info">Birr {price}</span></h6>
                            <h6 className="font-weight-bold">Total Price to be paid : <span className="text-primary">Birr {daysLeft*price}</span></h6>
                        </div>
                    </div>
